...
/**
 * Calculates whether an incoming alert escalates the incident severity.
 * Rule: Incidents only escalate upwards. Zero automatic de-escalation is allowed on alert recovery or lower severity alerts.
 */
