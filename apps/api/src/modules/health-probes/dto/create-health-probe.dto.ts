...
import { ProbeType } from '@prisma/client';

export class CreateHealthProbeDto {
  @ApiProperty({ example: 'HTTP Liveness Probe' })
  @IsString()
  @IsNotEmpty()
  @MaxLength(100)
  name!: string;

  @ApiProperty({ description: 'Service Environment ID to probe' })
  @IsString()
  @IsNotEmpty()
  environmentId!: string;

  @ApiProperty({ enum: ProbeType, default: ProbeType.HTTP })
  @IsEnum(ProbeType)
  probeType!: ProbeType;
  ...
  @ApiPropertyOptional({ example: 30, minimum: 10, maximum: 900, description: 'Interval in seconds' })
  @IsOptional()
  @IsInt()
  @Min(10)
  @Max(900)
  ...
  @ApiPropertyOptional({ example: 5000, minimum: 250, maximum: 10000, description: 'Timeout in milliseconds' })
  @IsOptional()
  @IsInt()
  @Min(250)
  @Max(10000)
